...
class AboutComprehension(Koan):
    ...
    def test_double_list_comprehension(self):
        ...
        comprehension = [ '{1} and {0}'.format(egg, meat) for egg in list_of_eggs for meat in list_of_meats]
        # ['lite spam and poached egg', 'ham spam and poached egg', 'fried spam and poached egg', 'lite spam and fried egg', 'ham spam and fried egg', 'fried spam and fried egg']
        comprehension = [ '{0} and {1}'.format(egg, meat) for egg in list_of_eggs for meat in list_of_meats]
        # ['poached egg and lite spam', 'poached egg and ham spam', 'poached egg and fried spam', 'fried egg and lite spam', 'fried egg and ham spam', 'fried egg and fried spam']
    ...
    def test_creating_a_set_with_set_comprehension(self):
        ...
        self.assertEqual({'c', 'b', 'a'}, comprehension)  # remember that set members are unique
